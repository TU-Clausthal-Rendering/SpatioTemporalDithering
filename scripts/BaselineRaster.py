...
def render_graph_BaselineRaster():
    ...
    g.add_edge('RasterVBuffer.depth', 'SVAO.gbufferDepth')
    g.add_edge('LinearizeDepth.linearDepth', 'SVAO.depth')
    g.add_edge('RasterVBuffer.vbuffer', 'UnpackVBuffer.vbuffer')
    ...
    g.add_edge('CrossBilateralBlur.colorOut', 'VBufferLighting.ambient')
