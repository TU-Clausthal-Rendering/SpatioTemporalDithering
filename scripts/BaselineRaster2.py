...
def render_graph_BaselineRaster():
    ...
    g.create_pass('RasterOITDynFragment', 'RasterOITDynFragment', {})
    ...
    g.add_edge('RasterVBuffer.depth', 'RasterOITDynFragment.depth')
    g.add_edge('RasterOITDynFragment.color', 'VBufferLighting.transparency')
